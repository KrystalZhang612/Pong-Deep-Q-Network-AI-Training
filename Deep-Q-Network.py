...
class QLearner(nn.Module):
    ...
    def act(self, state, epsilon):
        ...
        #Greater epsilon indicates less probability for the if condition to be true 
...
def compute_td_loss(model, target_model, batch_size, gamma, replay_buffer):
    ...
    #Just a tensor of zeros. should be on cuda
    ...
    #Use MSELoss to sum up all the (expected_y_i - actual_q_i)^2
